...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "FirstByteCoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"firstbytecoin.com", "194.87.92.208"},
	{"194.87.92.208", "194.87.92.208"},
	{NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. FirstByteCoin is probably already running."), addrBind.ToString().c_str());
        else
